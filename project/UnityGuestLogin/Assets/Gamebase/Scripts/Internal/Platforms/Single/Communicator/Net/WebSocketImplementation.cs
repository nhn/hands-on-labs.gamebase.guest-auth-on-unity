...
namespace Toast.Gamebase.Single.Communicator
{
    ...
    {   
        ...
        public IEnumerator Reconnect(GamebaseCallback.ErrorDelegate callback)
        {
            ...
            GamebaseLog.Debug(string.Format("socket.ReadyState:{0}", socket.ReadyState), this, "Reconnect");
        ...
        public void StartRecvPolling()
        {
            ...
            recvPolling = GamebaseUnitySDKSettings.Instance.StartCoroutine(RecvPolling());
        }
        ...
        public void StopRecvPolling()
        {
            if (null != recvPolling)
            {
                GamebaseUnitySDKSettings.Instance.StopCoroutine(recvPolling);
                recvPolling = null;
            }
        }
        ...
        {
            GamebaseLog.Debug("socket connected.", this, "OnOpen");
        }
        ...
        {
            GamebaseLog.Debug("socket disconnected.", this, "OnClose");
        }
        #endregion
    }
}
