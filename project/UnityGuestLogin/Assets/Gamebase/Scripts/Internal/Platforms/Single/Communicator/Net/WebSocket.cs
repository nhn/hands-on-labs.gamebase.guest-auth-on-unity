...
namespace Toast.Gamebase.Single.Communicator
{
    public class WebSocket
    {
        ...
        {
            GamebaseUnitySDKSettings.Instance.StartCoroutine(InternetReachability((reachable) =>
            {
                if (true == reachable)
                {
        ...
        {            
            ...
            while (true == isTimeOutCheck)
            {
                ...
                {
                    GamebaseLog.Debug(string.Format("Time Out TransactionId : {0}", requestQueueItem.requestVO.transactionId.ToString()), this, "CheckTimeout");
            ...
            GamebaseLog.Debug("Finish time out check.", this, "CheckTimeout");
        }
