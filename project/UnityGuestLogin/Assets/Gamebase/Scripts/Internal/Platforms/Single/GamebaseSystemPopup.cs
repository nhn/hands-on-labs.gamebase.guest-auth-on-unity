...
namespace Toast.Gamebase.Single
{
    public class GamebaseSystemPopup
    {
        ...
        public void ShowLaunchingPopup(LaunchingResponse.LaunchingInfo launchingInfo)
        {
            ...
            GamebaseLog.Debug(
                string.Format("LaunchingStatusCode : {0}", launchingInfo.launching.status.code),
                this,
                "ShowLaunchingPopup");
        ...
        {
            GamebaseLog.Debug("ShowKickOutPopup", this, "ShowKickOutPopup");
        ...
        {
            GamebaseLog.Debug("ShowServerPushPopup", this, "ShowServerPushPopup");
            ...
            {
                languageCode = GamebaseImplementation.Instance.GetLanguageCode();
                if (true == string.IsNullOrEmpty(languageCode) || false == popup.messages.ContainsKey(languageCode))
                {
