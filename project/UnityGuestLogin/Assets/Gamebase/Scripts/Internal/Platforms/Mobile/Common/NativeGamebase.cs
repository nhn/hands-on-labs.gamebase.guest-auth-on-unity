...
namespace Toast.Gamebase.Mobile
{
    public class NativeGamebase : IGamebase
    {
        protected class Gamebase
        {
            ...
            public const string GAMEBASE_API_GET_LANGUAGE_CODE               = "gamebase://getLanguageCode";
        ...
        virtual public void SetDebugMode(bool isDebugMode)
        {
            ...
            string jsonData = JsonMapper.ToJson(new UnityMessage(Gamebase.GAMEBASE_API_SET_DEBUG_MODE, jsonData: JsonMapper.ToJson(vo)));
        ...
        virtual public string GetLanguageCode()
        {
            string jsonData = JsonMapper.ToJson(new UnityMessage(Gamebase.GAMEBASE_API_GET_LANGUAGE_CODE));
            return messageSender.GetSync(jsonData);
        }
        ...
        {
            string jsonData = JsonMapper.ToJson(new UnityMessage(Gamebase.GAMEBASE_API_SET_DISPLAY_LANGUAGE_CODE, jsonData: languageCode));
        ...
        virtual public void AddObserver(int handle)
        {
            ...
            {
                string jsonData = JsonMapper.ToJson(new UnityMessage(Gamebase.GAMEBASE_API_ADD_OBSERVER, handle: handle, gameObjectName: GamebaseUnitySDK.ObjectName, requestMethodName: "OnAsyncEvent"));
                messageSender.GetSync(jsonData);
            }
        }
        ...
        virtual public void AddServerPushEvent(int handle)
        {
            ...
            {
                string jsonData = JsonMapper.ToJson(new UnityMessage(Gamebase.GAMEBASE_API_ADD_SERVER_PUSH_EVENT, handle: handle, gameObjectName: GamebaseUnitySDK.ObjectName, requestMethodName: "OnAsyncEvent"));
                messageSender.GetSync(jsonData);
            }
        }
