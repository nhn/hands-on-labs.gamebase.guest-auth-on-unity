...
namespace Toast.Gamebase.Mobile
{
    public class NativeGamebasePush : IGamebasePush
    {
        ...
        {
            string jsonData = JsonMapper.ToJson(new UnityMessage(GamebasePush.PUSH_API_QUERY_PUSH, handle: handle, gameObjectName: GamebaseUnitySDK.ObjectName, requestMethodName: "OnAsyncEvent"));
            messageSender.GetAsync(jsonData);
        }
