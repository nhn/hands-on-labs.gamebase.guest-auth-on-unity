...
{
    public class GamebaseUnitySDK
    {
        private const string sdkVersion = "1.12.1";

        public static bool IsInitialized { get; set; }
        public static string ObjectName { get; set; }
        public static string SDKVersion { get { return sdkVersion; } }
        ...
        public static bool UseWebview { get; set; }
        ...
        public static string Language { get { return Get2LetterISOCodeFromSystemLanguage(); } }
        ...
        {
            if (false == string.IsNullOrEmpty(deviceKey) && false == deviceKey.Equals("n/a", StringComparison.Ordinal))
            {
                return deviceKey;
            }
