...
#define GAMEBASE_API_GET_LANGUAGE_CODE              @"gamebase://getLanguageCode"
...
@synthesize observerRequestMethodName               = _observerRequestMethodName;
@synthesize observerHandle                          = _observerHandle;
@synthesize serverPushEventGameObjectName           = _serverPushEventGameObjectName;
@synthesize serverPushEventRequestMethodName        = _serverPushEventRequestMethodName;
...
- (instancetype)init {
    ...
    _serverPushMessage = ^(TCGBServerPushMessage* message){
        ...
        NativeMessage* requestMessage = [[NativeMessage alloc] initWithMessage:GAMEBASE_API_ADD_SERVER_PUSH_EVENT handle:tempSelf.serverPushEventHandle TCGBError:nil jsonData:jsonString extraData:nil];
        
        [[UnityMessageSender sharedUnityMessageSender] sendMessage:requestMessage gameObjectName:tempSelf.serverPushEventGameObjectName requestMethodName:tempSelf.serverPushEventRequestMethodName];
    };
    ...
    _observerMessage = ^(TCGBObserverMessage* message){
        ...
        NativeMessage* requestMessage = [[NativeMessage alloc] initWithMessage:GAMEBASE_API_ADD_OBSERVER handle:tempSelf.observerHandle TCGBError:nil jsonData:jsonString extraData:nil];
        
        [[UnityMessageSender sharedUnityMessageSender] sendMessage:requestMessage gameObjectName:tempSelf.observerGameObjectName requestMethodName:tempSelf.observerRequestMethodName];
    };
    ...
    [[DelegateManager sharedDelegateManager] addSyncDelegate:GAMEBASE_API_GET_LANGUAGE_CODE target:self selector:@selector(getLanguageCode:)];
...
-(void)initialize:(UnityMessage*)message {
    ...
    [TCGBGamebase initializeWithConfiguration:con completion:^(id launchingData, TCGBError *error) {
        ...
        NativeMessage* requestMessage = [[NativeMessage alloc]initWithMessage:message.scheme handle:message.handle TCGBError:error jsonData:[launchingData JSONString] extraData:nil];
...
-(NSString*)getLanguageCode:(UnityMessage*)message; {
    return [TCGBGamebase languageCode];
}
...
-(NSString*)addServerPushEvent:(UnityMessage*)message;{
    ...
    _serverPushEventRequestMethodName   = message.requestMethodName;
...
-(NSString*)removeServerPushEvent:(UnityMessage*)message;{
    ...
    _serverPushEventRequestMethodName   = nil;
...
-(NSString*)addObserver:(UnityMessage*)message;{
    ...
    _observerRequestMethodName          = message.requestMethodName;
...
-(NSString*)removeObserver:(UnityMessage*)message;{
    ...
    _observerRequestMethodName          = nil;
