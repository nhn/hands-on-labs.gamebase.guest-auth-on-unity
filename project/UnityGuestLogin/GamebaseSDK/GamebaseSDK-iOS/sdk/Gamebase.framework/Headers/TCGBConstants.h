...
//  Gamebase
//
//  Created by NHNENT on 2016. 5. 25..
...
typedef NS_ENUM(NSInteger, TCGBErrorCode) {
    ...
    // TransferKey
    TCGB_ERROR_AUTH_TRANSFERKEY_EXPIRED                  = 3031,
    TCGB_ERROR_AUTH_TRANSFERKEY_CONSUMED                 = 3032,
    TCGB_ERROR_AUTH_TRANSFERKEY_NOT_EXIST                = 3033,
